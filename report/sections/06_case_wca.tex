...
too-aggressive birth--death reverses the benefit as diversity collapses. The relative advantage \emph{grows with simulation budget}, is insensitive to
replica count, and removes the largest absolute error in the densest, hardest
solvent --- exactly the starved regime the support-reallocation mechanism
predicts.
