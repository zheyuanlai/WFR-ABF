...
\centering
\small
\caption{WCA main comparison (250k steps, $N=1024$, $a=1.5$). The tuned row is the practical headline; the strong row shows the accuracy--diversity tradeoff. The mean-force gain is modest.}
\label{tab:wca_main}
